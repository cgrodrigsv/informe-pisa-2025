            ...
            <div className="flex bg-slate-900 p-1 rounded-xl border border-slate-800">
              <button
                ...
                className={`px-3 py-1 text-xs font-semibold rounded-lg transition-all ${
                  scoreMetric === 'science' ? 'bg-sky-500 text-white shadow-sm' : 'text-slate-400 hover:text-slate-200'
                }`}
              >
                Ciencias
              </button>
              <button
                ...
                className={`px-3 py-1 text-xs font-semibold rounded-lg transition-all ${
                  scoreMetric === 'math' ? 'bg-indigo-500 text-white shadow-sm' : 'text-slate-400 hover:text-slate-200'
                }`}
              >
                Matemáticas
              </button>
              <button
                ...
                className={`px-3 py-1 text-xs font-semibold rounded-lg transition-all ${
                  scoreMetric === 'reading' ? 'bg-emerald-500 text-white shadow-sm' : 'text-slate-400 hover:text-slate-200'
                }`}
              >
                Lectura
              </button>
              <button
                ...
                className={`px-3 py-1 text-xs font-semibold rounded-lg transition-all ${
                  scoreMetric === 'digital' ? 'bg-amber-500 text-white shadow-sm' : 'text-slate-400 hover:text-slate-200'
                }`}
              >
                Mundo Digital
              </button>
          ...
          {(activeTab === 'both' || activeTab === 'rising') && (
            <div className="space-y-4">
              <div className="flex items-center justify-between px-2">
                ...
                <span className="text-xs text-slate-400 font-medium">Trayectoria 10 Años</span>
              </div>
                      ...
                      <div className="flex items-center space-x-3.5">
                        ...
                        <div>
                          <div className="flex items-center space-x-2">
                            <span className="text-base font-bold text-white">{sys.name}</span>
                      ...
                      <div className="flex items-center justify-between sm:justify-end space-x-4 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-800/60">
                        <div className="text-right">
                          ...
                          <div className="text-xl font-black font-display text-white">
                            {score} <span className="text-xs font-normal text-slate-400">pts</span>
                          </div>
                        </div>
          ...
          {(activeTab === 'both' || activeTab === 'declining') && (
            <div className="space-y-4">
              <div className="flex items-center justify-between px-2">
                ...
                <span className="text-xs text-slate-400 font-medium">Caída en 10 Años</span>
              </div>
