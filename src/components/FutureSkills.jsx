          ...
          <div className="lg:col-span-2 glass-card p-6 rounded-3xl border border-slate-800/80 flex flex-col justify-between">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">Promedio OCDE vs. Máximo Sistema Educativo Global</p>
              </div>
                ...
                >
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className="text-xs font-semibold text-slate-400">
                      OCDE: <strong className="text-white font-bold">{item.oecdScore} pts</strong>
                    </span>
                  </div>
                  ...
                  <div className="mt-2 pt-2 border-t border-slate-800/60 flex items-center justify-between text-[11px]">
                    <span className="text-slate-400">Líder: <strong className="text-sky-300">{item.topSystemName}</strong></span>
