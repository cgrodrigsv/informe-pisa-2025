  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      ...
      <div className="glass-card w-full max-w-2xl rounded-3xl border border-indigo-500/30 overflow-hidden shadow-2xl flex flex-col h-[580px]">
        ...
        <div className="bg-slate-900/90 px-6 py-4 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Consultas en tiempo real al informe original de 377 páginas</p>
            </div>
          </div>
        ...
        <div className="bg-slate-900/40 px-6 py-2.5 border-b border-slate-800/60 overflow-x-auto flex items-center space-x-2">
          ...
          {RAG_QA_BANK.map((qa, i) => (
            <button
              ...
              className="text-[11px] px-2.5 py-1 rounded-lg bg-slate-800/80 hover:bg-indigo-600 hover:text-white text-slate-300 border border-slate-700/60 whitespace-nowrap transition-colors"
            >
          ...
          {messages.map((msg, i) => (
            ...
            >
              <div className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 ${
                msg.sender === 'user'
                  ? 'bg-sky-500 text-white font-bold text-xs'
        ...
        >
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white font-semibold text-xs flex items-center space-x-1.5 transition-all"
          >
            <span>Buscar</span>
