        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <div className="glass-card rounded-2xl p-5 border border-slate-800/80">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h3 className="font-bold text-white">Curiosidad</h3>
            </div>
            <p className="text-xs text-slate-400">Estudiantes en El Salvador reportan un <span className="text-amber-400 font-bold">69%</span> de curiosidad general frente al 73% de la OCDE.</p>
          </div>
          <div className="glass-card rounded-2xl p-5 border border-slate-800/80">
            <div className="flex items-center space-x-3 mb-3">
              <div className="p-2 bg-emerald-500/20 rounded-lg"><Target className="w-5 h-5 text-emerald-400" /></div>
              <h3 className="font-bold text-white">Perseverancia</h3>
            </div>
            <p className="text-xs text-slate-400">El <span className="text-emerald-400 font-bold">65%</span> de salvadoreños aplica esfuerzo adicional ante retos, superando el promedio OCDE (60%).</p>
          </div>
          <div className="glass-card rounded-2xl p-5 border border-slate-800/80">
            <div className="flex items-center space-x-3 mb-3">
              <div className="p-2 bg-purple-500/20 rounded-lg"><Brain className="w-5 h-5 text-purple-400" /></div>
              <h3 className="font-bold text-white">Mentalidad de Crecimiento</h3>
            </div>
            <p className="text-xs text-slate-400">Solo el <span className="text-purple-400 font-bold">49%</span> cree que la inteligencia puede desarrollarse (vs 69% OCDE).</p>
          </div>
        </div>

        <div className="glass-card rounded-3xl p-6 h-[450px] w-full">
          <h3 className="text-sm font-bold text-white mb-4 text-center">Comparativa: Curiosidad vs Mentalidad de Crecimiento</h3>
