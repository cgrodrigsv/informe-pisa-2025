...
import { Atom, Calculator, BookOpen, Cpu, Sparkles, Globe, FileText } from 'lucide-react';

export default function Navbar({ activeDomain, setActiveDomain, onOpenRagModal }) {
  const domains = [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div>
              ...
              <h1 className="text-lg sm:text-xl font-bold font-display text-white tracking-tight">
                Resultados PISA 2025 <span className="hidden sm:inline font-normal text-slate-400">| El Estado de la Educación Global</span>
              </h1>
            </div>
          </div>

          {/* Domain Filter Buttons & RAG Trigger */}
          <div className="flex flex-wrap items-center gap-2">
            ...
            {/* RAG Assistant Modal Trigger */}
            <button
              onClick={onOpenRagModal}
              className="flex items-center space-x-2 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white text-xs font-semibold shadow-lg shadow-indigo-500/20 transition-all hover:scale-105 active:scale-95 border border-purple-400/20"
            >
